...
export const results: Record<string, Result> = {
  ...
  unitedStatesSprint: {
    ...
    constructors: [
      { teamId: "red_bull", points: 8 },
      { teamId: "ferrari", points: 12 },
      { teamId: "mclaren", points: 6 },
      { teamId: "mercedes", points: 7 },
      { teamId: "haas", points: 3 },
      { teamId: "rb", points: 0 },
      { teamId: "williams", points: 0 },
      { teamId: "aston_martin", points: 0 },
  ...
  unitedStates: {
    ...
    constructors: [
      { teamId: "ferrari", points: 43 },
      { teamId: "red_bull", points: 21 },
      { teamId: "mclaren", points: 22 },
      { teamId: "mercedes", points: 8 },
      { teamId: "haas", points: 4 },
      { teamId: "rb", points: 2 },
      { teamId: "williams", points: 1 },
      { teamId: "alpine", points: 0 },
      { teamId: "aston_martin", points: 0 },
      { teamId: "sauber", points: 0 },
    ],
  ...
  mexico: {
    ...
    constructors: [
      { teamId: "ferrari", points: 41 },
      { teamId: "mclaren", points: 22 },
      { teamId: "mercedes", points: 22 },
      { teamId: "red_bull", points: 8 },
      { teamId: "haas", points: 8 },
      { teamId: "alpine", points: 1 },
      { teamId: "aston_martin", points: 0 },
  ...
  brazilSprint: {
    ...
    constructors: [
      { teamId: "mclaren", points: 15 },
      { teamId: "ferrari", points: 10 },
      { teamId: "red_bull", points: 6 },
      { teamId: "mercedes", points: 3 },
      { teamId: "alpine", points: 2 },
      { teamId: "rb", points: 0 },
      { teamId: "williams", points: 0 },
      { teamId: "haas", points: 0 },
