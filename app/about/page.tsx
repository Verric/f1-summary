  ...
  return (
    <main>
      <article className="prose">
        ...
        <p>
          There are also things in the F1 reports that I don&apost care about. For example I don&apost care on what lap
          and what time of day a driver achieved their fastest lap
        </p>
        <p>
        ...
        <ul>
          <li>
            ...
            <p>
              ...
              race. Also for convenience I&aposve added differnce between the current entity and the entity above them
              to save myself the ardous task of basic arithmetic.
            </p>
          </li>
          <li>
